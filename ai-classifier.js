...
class LyanAIClassifier {
    constructor() {
        ...
        this.baselineTaxonomy = [
            ...
            { id: null, universe: "Maison & Travaux", category: "Peinture", subcategory: "Intérieur & Extérieur", synonyms: ["peinture", "peindre", "peintre", "enduit", "façade", "facade"], tags: ["#PEINTURE"], safety_level: "NORMAL" },
            { id: null, universe: "Maison & Travaux", category: "Climatisation", subcategory: "Pose & Entretien", synonyms: ["clim", "climatisation", "climatiseur", "split", "froid"], tags: ["#CLIM"], safety_level: "PRO_REQUIRED" },
            { id: null, universe: "Maison & Travaux", category: "Serrurerie", subcategory: "Ouverture & Serrure", synonyms: ["serrurier", "serrure", "porte claquée", "porte claquee", "clé", "cle"], tags: ["#SERRURERIE"], safety_level: "CAUTION" },
            { id: null, universe: "Maison & Travaux", category: "Électroménager", subcategory: "Réparation", synonyms: ["frigo", "lave-linge", "lave linge", "four", "électroménager", "electromenager"], tags: ["#ELECTROMENAGER"], safety_level: "NORMAL" },
            { id: null, universe: "Jardin & Extérieur", category: "Élagage", subcategory: "Taille d’arbres", synonyms: ["élagage", "elagage", "arbre", "cocotier", "manguier", "abattage"], tags: ["#ELAGAGE"], safety_level: "CAUTION" },
            { id: null, universe: "Transport & Livraison", category: "Aéroport", subcategory: "Transfert", synonyms: ["aéroport", "aeroport", "navette aéroport", "ptg"], tags: ["#AEROPORT"], safety_level: "NORMAL" },
            { id: null, universe: "Informatique & Numérique", category: "Smartphone", subcategory: "Réglage & Dépannage", synonyms: ["smartphone", "iphone", "android", "whatsapp", "téléphone", "telephone"], tags: ["#SMARTPHONE"], safety_level: "NORMAL" },
            { id: null, universe: "Aide du Quotidien", category: "Garde d’enfants", subcategory: "Babysitting", synonyms: ["babysitting", "baby-sitting", "garde enfant", "nounou", "enfants"], tags: ["#BABYSITTING"], safety_level: "NORMAL" },
            { id: null, universe: "Beauté & Bien-être", category: "Maquillage", subcategory: "Événementiel", synonyms: ["maquillage", "make-up", "makeup", "maquilleuse"], tags: ["#MAQUILLAGE"], safety_level: "NORMAL" },
            { id: null, universe: "Événementiel", category: "DJ & Son", subcategory: "Animation musicale", synonyms: ["dj", "sono", "sonorisation", "mix", "animation"], tags: ["#DJ"], safety_level: "NORMAL" },
            { id: null, universe: "Événementiel", category: "Traiteur", subcategory: "Repas événement", synonyms: ["traiteur", "buffet", "cocktail", "plat créole", "plat creole"], tags: ["#TRAITEUR"], safety_level: "NORMAL" },
            { id: null, universe: "Sport & Activités", category: "Fitness", subcategory: "Coaching sportif", synonyms: ["coach sportif", "fitness", "musculation", "remise en forme"], tags: ["#FITNESS"], safety_level: "NORMAL" },
            { id: null, universe: "Sport & Activités", category: "Danse", subcategory: "Cours de danse", synonyms: ["danse", "zouk", "kompa", "salsa"], tags: ["#DANSE"], safety_level: "NORMAL" },
            { id: null, universe: "Mer & Nautisme", category: "Bateau", subcategory: "Entretien & Sortie", synonyms: ["bateau", "annexe", "hors-bord", "hors bord", "nautisme"], tags: ["#BATEAU"], safety_level: "NORMAL" },
            { id: null, universe: "Cuisine & Alimentation", category: "Traiteur domicile", subcategory: "Plats à emporter", synonyms: ["bokit", "accras", "colombo", "plat du jour", "cuisiner pour moi"], tags: ["#TRAITEUR_DOMICILE"], safety_level: "NORMAL" },
            { id: null, universe: "Administratif", category: "Traduction", subcategory: "FR / EN / ES / Créole", synonyms: ["traduction", "traducteur", "interprète", "interprete"], tags: ["#TRADUCTION"], safety_level: "NORMAL" }
        ];
