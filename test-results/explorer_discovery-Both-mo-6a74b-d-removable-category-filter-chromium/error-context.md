...
- Name: explorer_discovery.spec.js >> Both modes use the same database taxonomy and removable category filter
- Location: tests/e2e/explorer_discovery.spec.js:89:1
