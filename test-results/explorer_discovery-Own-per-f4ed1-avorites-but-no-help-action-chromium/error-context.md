...
- Name: explorer_discovery.spec.js >> Own persisted Requests have details and favorites but no help action
- Location: tests/e2e/explorer_discovery.spec.js:286:1

# Error details

```
Error: Existing QA A email is required
