...
function injectMobileInterface() {
    ...
    // ==========================================================================
    // INJECTION DYNAMIQUE DE 50 PROFILS IA ENTIÈREMENT AUTONOMES
    // ==========================================================================
    const ADDITIONAL_MEMBERS_DATA = [
        ...
        // MARTINIQUE (972)
        { name: "Fabrice Létang", age: 40, role: "Électricité générale", cat: "electricite", city: "Fort-de-France", loc: "martinique", locName: "Martinique (972)", rate: "35€/h", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80", bio: "Électricien professionnel à Fort-de-France. Tableau électrique, prises et mise en conformité.", skills: ["Tableau", "Câblage", "Dépannage"] },
        { name: "Ghislaine Rosalie", age: 50, role: "Aide à domicile & Compagnie", cat: "aide-personne", city: "Le Lamentin", loc: "martinique", locName: "Martinique (972)", rate: "18€/h", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80", bio: "Accompagnement quotidien des personnes âgées au Lamentin. Présence et écoute attentive.", skills: ["Compagnie", "Courses", "Loisirs"] },
        { name: "Wilfrid Rapon", age: 37, role: "Jardinier paysagiste", cat: "jardin", city: "Le Robert", loc: "martinique", locName: "Martinique (972)", rate: "25€/h", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80", bio: "Paysagiste passionné. Création de massifs, entretien général de jardin au Robert.", skills: ["Taille", "Plantation", "Décoration"] },
        { name: "Christiane Fostin", age: 58, role: "Citoyenne engagée", cat: "citoyen", city: "Schœlcher", loc: "martinique", locName: "Martinique (972)", rate: "N/A", img: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=150&q=80", bio: "Résidente à Schœlcher. Toujours partante pour discuter d'initiatives solidaires locales.", skills: ["Partage", "Voisinage", "Rencontres"] },
        { name: "Lucien Cabort", age: 48, role: "Bricolage & Multi-services", cat: "bricolage", city: "Sainte-Marie", loc: "martinique", locName: "Martinique (972)", rate: "22€/h", img: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=150&q=80", bio: "Homme à tout faire à Sainte-Marie. Dépannages divers et montages en tous genres.", skills: ["Réparations", "Montage", "Pose rideaux"] },
        { name: "Roselyne Dacosta", age: 32, role: "Voisine de confiance", cat: "citoyen", city: "Ducos", loc: "martinique", locName: "Martinique (972)", rate: "N/A", img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80", bio: "Citoyenne active à Ducos. Passionnée d'environnement et de troc de plantes dans le quartier.", skills: ["Plantes", "Discussion", "Troc"] },
        { name: "Albert Lise", age: 65, role: "Cuisine & Repas créoles", cat: "divers", city: "Saint-Joseph", loc: "martinique", locName: "Martinique (972)", rate: "20€/h", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80", bio: "Retraité de la restauration à Saint-Joseph. Préparation de plats traditionnels et pâtisseries locales.", skills: ["Colombo", "Accras", "Pâtisserie"] },
        { name: "Yveline Rosalie", age: 23, role: "Baby-sitting & Aide devoirs", cat: "babysitting", city: "La Trinité", loc: "martinique", locName: "Martinique (972)", rate: "14€/h", img: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80", bio: "Étudiante en éducation à la Trinité. Aide aux devoirs et garde d'enfants après l'école.", skills: ["Devoirs", "Baby-sitting", "Jeux éducatifs"] },
        { name: "Gérard Zami", age: 55, role: "Plombier dépannage", cat: "plomberie", city: "Rivière-Pilote", loc: "martinique", locName: "Martinique (972)", rate: "30€/h", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=150&q=80", bio: "Plombier à Rivière-Pilote. Installation et réparation de réseaux d'eau, réparation robinets.", skills: ["Plomberie", "Sanitaire", "Chauffe-eau"] },
        { name: "Francine Moutoussamy", age: 44, role: "Repassage & Couture", cat: "menage", city: "Le François", loc: "martinique", locName: "Martinique (972)", rate: "18€/h", img: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=150&q=80", bio: "Couturière et repasseuse au François. Soin apporté au linge et petites retouches.", skills: ["Repassage", "Couture", "Ourlets"] },

        // GUYANE (973)
        { name: "Guy-Albert Gace", age: 39, role: "Électricien dépannage", cat: "electricite", city: "Cayenne", loc: "guyane", locName: "Guyane (973)", rate: "35€/h", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80", bio: "Dépannage d'urgence à Cayenne. Électricité de maison, branchements et disjoncteurs.", skills: ["Dépannage", "Tableaux", "Mise aux normes"] },
        { name: "Solange Silvestre", age: 28, role: "Ménage & Nettoyage vitres", cat: "menage", city: "Saint-Laurent-du-Maroni", loc: "guyane", locName: "Guyane (973)", rate: "18€/h", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80", bio: "Nettoyage en profondeur à Saint-Laurent. Sérieuse, rapide, organisée et de confiance.", skills: ["Nettoyage", "Vitres", "Linge"] },
        { name: "Firmin Monlouis", age: 51, role: "Jardinage & Élagage", cat: "jardin", city: "Kourou", loc: "guyane", locName: "Guyane (973)", rate: "25€/h", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80", bio: "Jardinier sur Kourou. Taille de haies, tonte et élagage des petits arbres du jardin.", skills: ["Jardin", "Élagage", "Tondeuse"] },
        { name: "Monique Carpin", age: 59, role: "Voisine solidaire", cat: "citoyen", city: "Matoury", loc: "guyane", locName: "Guyane (973)", rate: "N/A", img: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=150&q=80", bio: "Voisine solidaire à Matoury. Disposée à aider pour récupérer des colis ou garder un animal en votre absence.", skills: ["Entraide", "Garde chien", "Services"] },
        { name: "Martial Tinaut", age: 33, role: "Montage de meubles", cat: "bricolage", city: "Remire-Montjoly", loc: "guyane", locName: "Guyane (973)", rate: "22€/h", img: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=150&q=80", bio: "Super bricoleur à Remire. Assemblage de meubles en kit et fixations murales diverses.", skills: ["Montage meuble", "Fixation TV", "Petits travaux"] },
        { name: "Ginette Tacite", age: 64, role: "Aide aux repas & Seniors", cat: "aide-personne", city: "Macouria", loc: "guyane", locName: "Guyane (973)", rate: "18€/h", img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80", bio: "Accompagnatrice sociale retraitée. Aide à la personne et compagnie bienveillante à Macouria.", skills: ["Seniors", "Compagnie", "Aide administrative"] },
        { name: "Aimé Zéphir", age: 46, role: "Peintre d'intérieur", cat: "peinture", city: "Maripasoula", loc: "guyane", locName: "Guyane (973)", rate: "25€/h", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80", bio: "Peintre d'expérience à Maripasoula. Travail propre et soigné pour vos murs et boiseries.", skills: ["Peinture", "Enduit", "Rénovation"] },
        { name: "Josiane Périac", age: 24, role: "Baby-sitting soirées", cat: "babysitting", city: "Mana", loc: "guyane", locName: "Guyane (973)", rate: "14€/h", img: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80", bio: "Garde d'enfants de confiance à Mana. Jeux, dîner et accompagnement au coucher.", skills: ["Baby-sitting", "Éveil", "Sûreté"] },
        { name: "Pascal Agathe", age: 43, role: "Plomberie sanitaire", cat: "plomberie", city: "Apatou", loc: "guyane", locName: "Guyane (973)", rate: "28€/h", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=150&q=80", bio: "Dépannage plomberie à Apatou. Réparations robinetterie, fuites et siphons.", skills: ["Plomberie", "Robinets", "Canalisations"] },
        { name: "Sylviane Lurel", age: 53, role: "Habitante engagée", cat: "citoyen", city: "Grand-Santi", loc: "guyane", locName: "Guyane (973)", rate: "N/A", img: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=150&q=80", bio: "Habitante de Grand-Santi. Intéressée par les actions d'entraide et d'animation solidaire.", skills: ["Discussions", "Solidarité", "Projets"] },

        // LA RÉUNION (974)
        { name: "Max Hoarau", age: 42, role: "Climatisation & Froid", cat: "climatisation", city: "Saint-Denis", loc: "reunion", locName: "La Réunion (974)", rate: "35€/h", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80", bio: "Expert climatisation à Saint-Denis. Entretien, désinfection et installation neuve de clim.", skills: ["Entretien", "Pose", "Climatiseur"] },
        { name: "Eliane Hoarau", age: 49, role: "Aide à domicile & Repas", cat: "aide-personne", city: "Saint-Paul", loc: "reunion", locName: "La Réunion (974)", rate: "18€/h", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80", bio: "Aide quotidienne à Saint-Paul. Préparation de caris et repas typiques réunionnais.", skills: ["Cuisine", "Ménage", "Compagnie"] },
        { name: "Charles Payet", age: 36, role: "Jardinier & Entretien cour", cat: "jardin", city: "Saint-Pierre", loc: "reunion", locName: "La Réunion (974)", rate: "25€/h", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80", bio: "Jardinier motivé sur Saint-Pierre. Débroussaillage, tonte et nettoyage complet de cours.", skills: ["Tonte", "Taille de haie", "Nettoyage"] },
        { name: "Patricia Grondin", age: 57, role: "Habitante solidaire", cat: "citoyen", city: "Le Tampon", loc: "reunion", locName: "La Réunion (974)", rate: "N/A", img: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=150&q=80", bio: "Lyanneuse passionnée au Tampon. Partage de boutures et conseils pour potager tropical.", skills: ["Jardinage", "Troc", "Voisinage"] },
        { name: "Georges Payet", age: 48, role: "Petit Bricolage & Fixation", cat: "bricolage", city: "Saint-André", loc: "reunion", locName: "La Réunion (974)", rate: "22€/h", img: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=150&q=80", bio: "Bricoleur à Saint-André. Montage meuble, pose tringles à rideaux, cadres et étagères.", skills: ["Bricolage", "Fixation", "Montage"] },
        { name: "Nicole Payet", age: 33, role: "Ménage & Repassage", cat: "menage", city: "Saint-Louis", loc: "reunion", locName: "La Réunion (974)", rate: "18€/h", img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80", bio: "Prestation de ménage impeccable à Saint-Louis. Organisation, discrétion et efficacité.", skills: ["Ménage", "Repassage", "Rangement"] },
        { name: "Henri Payet", age: 60, role: "Dépannage électricité", cat: "electricite", city: "Le Port", loc: "reunion", locName: "La Réunion (974)", rate: "35€/h", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80", bio: "Électricien d'expérience au Port. Dépannage rapide de pannes de prises, fusibles ou luminaires.", skills: ["Dépannage", "Mise aux normes", "Câblage"] },
        { name: "Claudette Payet", age: 25, role: "Baby-sitting & Sorties", cat: "babysitting", city: "Saint-Joseph", loc: "reunion", locName: "La Réunion (974)", rate: "14€/h", img: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80", bio: "Garde d'enfants douce et active à Saint-Joseph. Aide aux devoirs scolaires.", skills: ["Garde", "Aide devoirs", "Activités"] },
        { name: "René Payet", age: 51, role: "Peinture & Enduits", cat: "peinture", city: "Saint-Benoît", loc: "reunion", locName: "La Réunion (974)", rate: "25€/h", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=150&q=80", bio: "Artisan peintre à Saint-Benoît. Rénovation de murs, façades et boiseries.", skills: ["Peinture", "Enduit", "Rénovation"] },
        { name: "Yolande Payet", age: 45, role: "Voisine active", cat: "citoyen", city: "Sainte-Marie", loc: "reunion", locName: "La Réunion (974)", rate: "N/A", img: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=150&q=80", bio: "Voisine chaleureuse à Sainte-Marie. Toujours prête pour un coup de main amical ou prêter un outil.", skills: ["Entraide", "Covoiturage", "Café"] },

        // SAINT-MARTIN (978)
        { name: "Gaston Placide", age: 47, role: "Électricien dépanneur", cat: "electricite", city: "Marigot", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "35€/h", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80", bio: "Électricien à Marigot. Pose, diagnostic et réparation rapide de vos réseaux.", skills: ["Électricité", "Dépannage", "Luminaire"] },
        { name: "Marcelle Placide", age: 54, role: "Aide à la personne", cat: "aide-personne", city: "Grand-Case", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "18€/h", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80", bio: "Aide à domicile attentionnée à Grand-Case. Accompagnement courses et ménage quotidien.", skills: ["Aide", "Courses", "Cuisine"] },
        { name: "Bruno Placide", age: 38, role: "Bricolage & Multi-services", cat: "bricolage", city: "Quartier-d'Orléans", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "25€/h", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80", bio: "Petit entretien de maison et jardin à Quartier-d'Orléans. Polyvalent, ponctuel et soigné.", skills: ["Bricolage", "Montage", "Ajustement"] },
        { name: "Thérèse Placide", age: 63, role: "Voisine active", cat: "citoyen", city: "Gustavia", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "N/A", img: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=150&q=80", bio: "Retraitée active à Gustavia. Organise des ateliers tricot et de l'entraide de quartier.", skills: ["Tissage", "Partage", "Voisinage"] },
        { name: "Gilbert Placide", age: 52, role: "Jardinier & Entretien cour", cat: "jardin", city: "Saint-Jean", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "25€/h", img: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=150&q=80", bio: "Entretien de jardins à Saint-Jean. Tonte, taille et débroussaillage de terrain arboré.", skills: ["Taille", "Nettoyage", "Jardin"] },
        { name: "Jacqueline Placide", age: 29, role: "Ménage de vacances", cat: "menage", city: "Marigot", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "18€/h", img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80", bio: "Ménage et préparation de locations saisonnières sur Marigot. Réactive et rigoureuse.", skills: ["Ménage", "Location", "Préparation"] },
        { name: "Raymond Placide", age: 35, role: "Plomberie générale", cat: "plomberie", city: "Grand-Case", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "30€/h", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80", bio: "Plombier disponible à Grand-Case. Changement de robinets, raccordements et débouchage.", skills: ["Robinetterie", "Débouchage", "Réparations"] },
        { name: "Marie-Andrée Placide", age: 41, role: "Baby-sitting à domicile", cat: "babysitting", city: "Quartier-d'Orléans", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "14€/h", img: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80", bio: "Garde d'enfants expérimentée à Quartier-d'Orléans. Disponible en soirée et week-end.", skills: ["Baby-sitting", "Accompagnement", "Loisirs"] },
        { name: "Serge Placide", age: 55, role: "Peintre bâtiment", cat: "peinture", city: "Gustavia", loc: "saint-martin", locName: "St-Martin / St-Barth", rate: "25€/h", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=150&q=80", bio: "Peintre d'expérience à Gustavia. Rénovations intérieures et extérieures, peintures façades.", skills: ["Peinture", "Façades", "Volets"] },
