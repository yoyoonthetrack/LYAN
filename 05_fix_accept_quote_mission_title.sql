-- ============================================================================
-- LYANN DOM — 05_FIX_ACCEPT_QUOTE_MISSION_TITLE.SQL
-- Migration corrective minimale pour accept_request_quote()
-- Alimentation de la colonne NOT NULL missions.title depuis public.requests.title
-- ============================================================================
...
BEGIN
    ...
    -- 8. Création atomique de la mission liée (avec title issu de requests.title + fallback de sécurité)
    BEGIN
        INSERT INTO public.missions (
            ...
            COALESCE(v_req_record.description, v_quote_record.description),
            v_req_record.category,
            v_req_record.location,
            'AGREED',
